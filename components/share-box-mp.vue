			...
			<view class='shareList g-flex '>
				...
				<view class='shareItem g-flex-item'>
					<view class='shareBtn'>
						<button open-type="share" style='line-height:0' hover-class="none">
							<image src='https://e-mall-1316691179.cos.ap-shanghai.myqcloud.com/mall/appicon/images/friend.png' style='width:100upx;height:100upx;margin-bottom:6upx'></image>
						</button>
				...
				<view class='shareItem g-flex-item'>
					<view class='shareBtn' @click='shareQRCode'>
						<image src='https://e-mall-1316691179.cos.ap-shanghai.myqcloud.com/mall/appicon/images/allfriend.png' style='width:100upx;height:100upx'></image>
						<label>{{__('生成海报')}}</label>
					</view>
				</view>
			</view>
