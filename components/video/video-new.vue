<template>
	<view style="position: relative;"
		...
		<cover-image class="play" v-if="show_play" src="https://e-mall-1316691179.cos.ap-shanghai.myqcloud.com/mall/appicon/video/play_1.png"
		...
		<cover-view class="cover-view-right">
			...
			<cover-image v-if="is_like" src="https://e-mall-1316691179.cos.ap-shanghai.myqcloud.com/mall/appicon/video/img/axc.png" class="img-left" @click.stop="onUnLike" :data-story_id="video_id"></cover-image>

			<cover-image v-if="!is_like" src="https://e-mall-1316691179.cos.ap-shanghai.myqcloud.com/mall/appicon/video/img/bed.png" class="img-left" @click.stop="onLike" :data-story_id="video_id"></cover-image>


			<text class="right-text">{{ story_like_count }}</text>
			<cover-image src="https://e-mall-1316691179.cos.ap-shanghai.myqcloud.com/mall/appicon/video/img/ay2.png" style="height: 80upx;" class="img-left" @click.stop="tapMsg"></cover-image>
			<text class="right-text">{{ pinglun }}</text>
			<cover-image src="https://e-mall-1316691179.cos.ap-shanghai.myqcloud.com/mall/appicon/video/img/b6p.png" style="height: 76upx;" class="img-left" @click.stop="tapShare"></cover-image>
			<text class="right-text">{{ zhuanfa }}</text>
			<cover-image src="https://e-mall-1316691179.cos.ap-shanghai.myqcloud.com/mall/appicon/video/changpian.png" class="musicIcon cimg"></cover-image>
		</cover-view>
