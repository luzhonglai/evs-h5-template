<script>
	...
	// 引入检查更新模块
	import { checkUpdater } from '@/helpers/checkUpdater'
	...
	export default {
		...
		onLaunch: function(options) {
			...
			if (updated.completed === true) { // 如果上次刚更新过
				...
				checkUpdater(this.$current.id, '../index/update')
			}
			*/
			// #endif
            ...
            // #ifdef APP-PLUS
            var server = Config.URL.update_app; //检查更新地址
            var req = { //升级检测数据
            ...
            uni.request({
                ...
                data: req,
                success: (result) => {
                    if (result.statusCode === 200 && result.data.status === 200 && result.data.data.status) {
									...
									uni.showModal({
										...
										success: function (res) {
											if (res.confirm) {
												...
												{
													//领取操作
													let tmp_params = {user_other_id:data.msg_row.user_other_id}
													that.$.request({
...
*/
	...
	.m-product-price1 {
		...
		.c1 {
			...
			width: 40upx;
			height: 40upx;
			background: url(https://e-mall-1316691179.cos.ap-shanghai.myqcloud.com/mall/appicon/pc1.png) center no-repeat;
		...
		.c2 {
			...
			width: 50upx;
			height: 50upx;
			background: url(https://e-mall-1316691179.cos.ap-shanghai.myqcloud.com/mall/appicon/pc2.png) center no-repeat;
			background-size: cover;
		}
		...
		.c3 {
			...
			font-size: 24upx;
			line-height: 50upx;
			background: url(https://e-mall-1316691179.cos.ap-shanghai.myqcloud.com/mall/appicon/pc3.png) center no-repeat;
			background-size: cover;
		}
	...
	.m-coupon-box-top {
		width: 600upx;
		height: 200upx;
		background: url(https://e-mall-1316691179.cos.ap-shanghai.myqcloud.com/mall/appicon/Coupon_box.png) top no-repeat;
		background-size: cover;
		margin-bottom: -80upx;
	}
	...
	.m-coupon-box-bottom {
		width: 600upx;
		height: 280upx;
		background: url(https://e-mall-1316691179.cos.ap-shanghai.myqcloud.com/mall/appicon/Coupon_box.png) bottom no-repeat;
		background-size: cover;
		margin-top: -70upx;
	}
	...
	*/
    ...
    .m-coupon-box-top {
        width: 600rpx;
        height: 220rpx;
        background: url(https://e-mall-1316691179.cos.ap-shanghai.myqcloud.com/mall/appicon/coupon/redbag_double.png) top no-repeat;
        background-size: cover;
    }
    ...
    .m-coupon-box-top2 {
        width: 600rpx;
        height: 220rpx;
        background: url(https://e-mall-1316691179.cos.ap-shanghai.myqcloud.com/mall/appicon/coupon/redbag_double2.png) top no-repeat;
        background-size: cover;
    }
    ...
    .m-coupon-box-bottom {
        width: 600rpx;
        height: 120rpx;
        background: url(https://e-mall-1316691179.cos.ap-shanghai.myqcloud.com/mall/appicon/coupon/redbag_double.png) bottom no-repeat;
        background-size: cover;
    }
    ...
    .m-coupon-box-content {
        width: 600rpx;
        max-height: 400rpx;
        background: url(https://e-mall-1316691179.cos.ap-shanghai.myqcloud.com/mall/appicon/coupon/redbag_double.png) center no-repeat;
        background-size: cover;
    }
    ...
    .m-coupon-box-item {
        width: 460rpx;
        height: 170rpx;
        background: url(https://e-mall-1316691179.cos.ap-shanghai.myqcloud.com/mall/appicon/coupon/coupon_muti.png) no-repeat;
        margin: 10rpx auto;
