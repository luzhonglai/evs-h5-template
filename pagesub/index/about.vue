    ...
    <view class="body">
        <view class="header member-top">
            <view class="header-top hide">
                <image :src="plantformInfo.bg || '/site/static/src/default/images/landing/bbc.jpg'"></image>
            </view>
            <view class="header-bottom"><text>{{plantformInfo.name}}</text></view>
            <view class="logo">
                <image :src="plantformInfo.logo"></image>
            </view>
        </view>
        ...
        <view class="message">
            <view class="title">{{__('公司信息')}}</view>
            <view class="peoplename aboutUs">
                <view>{{__('联 系 人：')}}</view><label>{{plantformInfo.site_company_name}}</label>
            </view>
            <view class="tel aboutUs" bindtap="call">
                <view>{{__('联系方式：')}}</view>
                <image src="https://e-mall-1316691179.cos.ap-shanghai.myqcloud.com/mall/appicon/img/call.png" style="width:30upx;height:30upx;margin-right:10upx"></image><label
                    style="color:#17abe3">{{plantformInfo.site_tel}}</label>
            </view>
            <view class="address aboutUs">
                <view>{{__('公司地址：')}}</view><label>{{plantformInfo.site_address}}</label>
            </view>
        </view>
    </view>
