			...
			<scroll-view class="keywordListBox" v-show="isShowKeywordList" scroll-y>
				<view class="keywordEntry" hover-class="keywordEntryTap" v-for="row in keywordList" wx:key="row.keyword">
					...
					<view class="keywordImg" @tap="setkeyword(row)">
						<image src="https://e-mall-1316691179.cos.ap-shanghai.myqcloud.com/mall/appicon/search/back.png"></image>
					</view>
				</view>
			</scroll-view>
			<scroll-view class="keywordBox" v-show="!isShowKeywordList" scroll-y>
				<view class="keyword-block" v-if="oldKeywordList.length>0">
					<view class="keyword-list-header">
						<view>历史搜索</view>
						<view>
							<image @tap="oldDelete" src="https://e-mall-1316691179.cos.ap-shanghai.myqcloud.com/mall/appicon/search/delete.png"></image>
						</view>
					</view>
					<view class="keyword">
				...
				<view class="keyword-block">
					<view class="keyword-list-header">
						<view>热门搜索</view>
						<view>
							<image @tap="hotToggle" :src="'https://e-mall-1316691179.cos.ap-shanghai.myqcloud.com/mall/appicon/search/attention'+forbid+'.png'"></image>
						</view>
					</view>
