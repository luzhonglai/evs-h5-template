			...
			<scroll-view class='u-pa1 fix-titlenview-trans' scroll-y="true" :scroll-top="scposition" @scroll="scrolltoupper">
				...
				<view class="m-store" v-if="(Config.MULTISHOP_ENABLE && !if_saas_status && !isStoreFlag)">
					<view class="m-store-info">
						...
						<label style="width:200upx;height:23upx;font-size:24upx;font-family:Alibaba PuHuiTi;font-weight:400;color:rgba(102,102,102,1);position: absolute;margin-top:60upx;margin-left:139upx">{{sprintf(__('在售商品%s件'), store_product_num)}}</label>
					...
					<view class="m-panel m-panel-access m-detail">
						...
						<view v-if="(ProductInfo.activityType=='GROUPBOOKING')" :class="'m-Packinglist ' + (tapindex==4?'':'hide')" style="font-size:24upx;">
							...
							<view style="text-align:left;line-height:40upx;">
								{{__('活动时间：')}}{{ProductInfo.EventStartTime}} - {{ProductInfo.EventEndTime}})
							</view>
							<view style="text-align:left;line-height:40upx;">
	...
	export default {
        ...
        */
			...
			onShareBox: function(e) {
				...
				// #ifdef MP-WEIXIN
				$href = "/pages/product/detail?pid=" + this.proId + "&uid=" + this.userInfo.user_id;
				// #endif
