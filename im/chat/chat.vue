                    ...
                    <block v-if="row.type=='system'">
                        <view class="system">
                            ...
                            <view v-if="row.msg.type=='redEnvelope'" class="red-envelope">
                                <image src="https://e-mall-1316691179.cos.ap-shanghai.myqcloud.com/mall/appicon/im/img/red-envelope-chat.png"></image>
                                {{row.msg.content.text}}
                            </view>
                        </view>
                    </block>
                        ...
                        <view class="my" v-if="row.msg.userinfo.uid==myuid">
                            ...
                            <view class="left">
                                ...
                                <view v-if="row.msg.type=='redEnvelope'" class="bubble red-envelope"
                                    ...
                                    <image src="https://e-mall-1316691179.cos.ap-shanghai.myqcloud.com/mall/appicon/im/img/red-envelope.png"></image>
                                    <view class="tis">
                                        <!-- 点击开红包 -->
                                    </view>
                                    <view class="blessing">
								...
								<view v-if="row.msg.type=='item'" class="bubble red-envelope" style="width: 100%;max-width: 100%;">
										...
										<navigator  :url="'/pages/product/detail' + '?pid=' + (row.msg.content.item_id)" class="m-product-item">
            ...
            >
                <swiper-item v-for="(page,pid) in emojiList" :key="pid">
                    <view v-for="(em,eid) in page" :key="eid" @tap="addEmoji(em)">
                        <image mode="widthFix" :src="'https://e-mall-1316691179.cos.ap-shanghai.myqcloud.com/mall/appicon/im/img/emoji/'+em.url"></image>
                    </view>
                </swiper-item>
            </swiper> -->
                ...
                <view class="list">
                    ...
                    <view class="box" @tap="yuyintonghua">
                        <image style="font-size:16px;width: 32px; height: 32px;"
                               src="https://e-mall-1316691179.cos.ap-shanghai.myqcloud.com/mall/appicon/im/img/more/yuyintonghua.png"></image>
                    </view>
                    <!-- #endif -->

                    <view class="box" @tap="weizhi" v-if="false">
                        <image style="font-size:16px;width: 32px; height: 32px;"
                               src="https://e-mall-1316691179.cos.ap-shanghai.myqcloud.com/mall/appicon/im/img/more/weizhi.png"></image>
                    </view>
                    <!-- <view class="box" @tap="handRedEnvelopes">
                        <image style="font-size:16px;width: 32px; height: 32px;"
                        src="https://e-mall-1316691179.cos.ap-shanghai.myqcloud.com/mall/appicon/im/img/more/红包.png"></image>
                    </view> -->

                    <view class="box" @tap="yuyinshuru" v-if="false">
                        <image style="font-size:16px;width: 32px; height: 32px;"
                               src="https://e-mall-1316691179.cos.ap-shanghai.myqcloud.com/mall/appicon/im/img/more/yuyinshuru.png"></image>
                    </view>

                    <view class="box" @tap="meShouchang" v-if="false">
                        <image style="font-size:16px;width: 32px; height: 32px;"
                               src="https://e-mall-1316691179.cos.ap-shanghai.myqcloud.com/mall/appicon/im/img/more/me-shouchang.png"></image>
                    </view>

                    <view class="box" @tap="userinfo" v-if="false">
                        <image style="font-size:16px;width: 32px; height: 32px;"
                               src="https://e-mall-1316691179.cos.ap-shanghai.myqcloud.com/mall/appicon/im/img/more/userinfo.png"></image>
                    </view>


                    <!-- <view class="box" @tap="handRedEnvelopes">
                        <image style="font-size:16px;width: 32px; height: 28px;" src="https://e-mall-1316691179.cos.ap-shanghai.myqcloud.com/mall/appicon/im/img/more/文件.png"></image>
                    </view> -->
                </view>
            </view>
        </view>
        ...
        <view class="input-box" :class="popupLayerClass" @touchmove.stop.prevent="discard">
            ...
            <view class="textbox">
                ...
                <view class="text-mode" :class="isVoice?'hidden':''">
                    <view class="box">
						<textarea  cursor-spacing="20" auto-height="true" v-model="textMsg" @focus="textareaFocus" />
                    </view>
            ...
            <view class="layer" @touchmove.stop.prevent="discard">
                <view class="open-redenvelope">
                    <view class="top">
                        ...
                        <image src="https://e-mall-1316691179.cos.ap-shanghai.myqcloud.com/mall/appicon/im/img/im/face/face_1.jpg"></image>
                    </view>
                                         ...
                                         let temdata= eval("("+res.data+")");
                                          ...
                                          switch(temdata.type){
                                               case 'getmessage':
                                                ...
                                                //{type:"user",msg:{id:1,type:"text",time:"12:56",userinfo:{uid:0,username:"大黑哥",face:"https://e-mall-1316691179.cos.ap-shanghai.myqcloud.com/mall/appicon/im/img/face.jpg"},content:{text:"为什么温度会相差那么大？"}}};
                                                   that.screenMsg(msg);
								...
								success: function(data, status, msg, code) {
									if (200 == status) {
										...
										let content = '<div class="chat-bubble-box">'
										    + imgstr + ' <a href="/pages/product/detail?pid=' + data.item_row.item_id + '">' + data.item_row.product_item_name + that.__('￥') + data.item_row.item_unit_price  + '</a></div>';
        ...
        onShow()
        {
            ...
            /*uni.getStorage({
                ...
                success:  (res)=>{
                    ...
                    lastid++;
                    let row = {type:"user",msg:{id:lastid,type:"redEnvelope",time:nowDate.getHours()+":"+nowDate.getMinutes(),userinfo:{uid:0,username:"大黑哥",face:"https://e-mall-1316691179.cos.ap-shanghai.myqcloud.com/mall/appicon/im/img/face.jpg"},content:{blessing:res.data.blessing,rid:Math.floor(Math.random()*1000+1),isReceived:false}}};
                    this.screenMsg(row);
        ...
        methods: {
            ...
            loadHistory(e)
            {
                ...
                setTimeout(() => {
                    ...
                    /*let list = [
                        {type:"user",msg:{id:1,type:"text",time:"12:56",userinfo:{uid:0,username:"大黑哥",face:"https://e-mall-1316691179.cos.ap-shanghai.myqcloud.com/mall/appicon/im/img/face.jpg"},content:{text:"为什么温度会相差那么大？"}}},
                        {type:"user",msg:{id:2,type:"text",time:"12:57",userinfo:{uid:1,username:"售后客服008",face:"https://e-mall-1316691179.cos.ap-shanghai.myqcloud.com/mall/appicon/im/img/im/face/face_2.jpg"},content:{text:"这个是有偏差的，两个温度相差十几二十度是很正常的，如果相差五十度，那即是质量问题了。"}}},
                        {type:"user",msg:{id:3,type:"voice",time:"12:59",userinfo:{uid:1,username:"售后客服008",face:"https://e-mall-1316691179.cos.ap-shanghai.myqcloud.com/mall/appicon/im/img/im/face/face_2.jpg"},content:{url:"/static/voice/1.mp3",length:"00:06"}}},
                        {type:"user",msg:{id:4,type:"voice",time:"13:05",userinfo:{uid:0,username:"大黑哥",face:"https://e-mall-1316691179.cos.ap-shanghai.myqcloud.com/mall/appicon/im/img/face.jpg"},content:{url:"/static/voice/2.mp3",length:"00:06"}}},
                    ]*/
                    let list = [];
                    if (list.length > 0)
                    {
            ...
            getMsgList(callback)
            {
                ...
                /* let list = [
                   ...
                   {type:"user",msg:{id:3,type:"voice",time:"12:59",userinfo:{uid:1,username:"售后客服008",face:"https://e-mall-1316691179.cos.ap-shanghai.myqcloud.com/mall/appicon/im/img/im/face/face_2.jpg"},content:{url:"/static/voice/1.mp3",length:"00:06"}}},
                   {type:"user",msg:{id:4,type:"voice",time:"13:05",userinfo:{uid:0,username:"大黑哥",face:"https://e-mall-1316691179.cos.ap-shanghai.myqcloud.com/mall/appicon/im/img/face.jpg"},content:{url:"/static/voice/2.mp3",length:"00:06"}}},
                   {type:"user",msg:{id:5,type:"img",time:"13:05",userinfo:{uid:0,username:"大黑哥",face:"https://e-mall-1316691179.cos.ap-shanghai.myqcloud.com/mall/appicon/im/img/face.jpg"},content:{url:"https://e-mall-1316691179.cos.ap-shanghai.myqcloud.com/mall/appicon/im/img/p10.jpg",w:200,h:200}}},
                   {type:"user",msg:{id:6,type:"img",time:"12:59",userinfo:{uid:1,username:"售后客服008",face:"https://e-mall-1316691179.cos.ap-shanghai.myqcloud.com/mall/appicon/im/img/im/face/face_2.jpg"},content:{url:"https://e-mall-1316691179.cos.ap-shanghai.myqcloud.com/mall/appicon/im/img/q.jpg",w:1920,h:1080}}},
                   {type:"system",msg:{id:7,type:"text",content:{text:"欢迎进入聊天室"}}},

                   {type:"system",msg:{id:9,type:"redEnvelope",content:{text:"售后客服008领取了你的红包"}}},
                   {type:"user",msg:{id:10,type:"redEnvelope",time:"12:56",userinfo:{uid:0,username:"大黑哥",face:"https://e-mall-1316691179.cos.ap-shanghai.myqcloud.com/mall/appicon/im/img/face.jpg"},content:{blessing:"恭喜发财，大吉大利，万事如意",rid:0,isReceived:false}}},
                   {type:"user",msg:{id:11,type:"redEnvelope",time:"12:56",userinfo:{uid:1,username:"售后客服008",face:"https://e-mall-1316691179.cos.ap-shanghai.myqcloud.com/mall/appicon/im/img/im/face/face_2.jpg"},content:{blessing:"恭喜发财",rid:1,isReceived:false}}},
               ]*/
                let tempmy = this.userInfo.im;
                console.info('tempmy')
                console.info(tempmy)
            ...
            sendMsg(content, type, needload = false)
            {
                ...
                /*setTimeout(()=>{
                    ...
                    lastid++;
                    msg = {type:'user',msg:{id:lastid,time:nowDate.getHours()+":"+nowDate.getMinutes(),type:type,userinfo:{uid:1,username:"售后客服008",face:"https://e-mall-1316691179.cos.ap-shanghai.myqcloud.com/mall/appicon/im/img/im/face/face_2.jpg"},content:content}}
                ...
                setTimeout(() => {
                    ...
                    if (rid == 0)
                    {
                        this.redenvelopeData = {
                            rid: 0,	//红包ID
                            from: "大黑哥",
                            face: "https://e-mall-1316691179.cos.ap-shanghai.myqcloud.com/mall/appicon/im/img/im/face/face.jpg",
                            blessing: "恭喜发财，大吉大利",
                            money: "已领完"
                        }
                    }
                    else
                    {
                        this.redenvelopeData = {
                            rid: 1,	//红包ID
                            from: "售后客服008",
                            face: "https://e-mall-1316691179.cos.ap-shanghai.myqcloud.com/mall/appicon/im/img/im/face/face_2.jpg",
                            blessing: "恭喜发财",
                            money: "0.01"
                        }
