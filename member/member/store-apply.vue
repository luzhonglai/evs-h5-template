            ...
            <view class="m-cell">
                ...
                <view class="m-cell-bd">
                    <picker mode="selector" @change="selectStoreType" :value="index" :range="store_type"
                        ...
                        <label style="padding:0 40upx;">{{store_type[index].name}}</label>
                    </picker>
                </view>
            </view>
            <view class="m-cell">
            ...
            <view class="m-cell" v-if="false">
                ...
                <view class="m-cell-bd">
                    <picker mode="selector" @change="selectStoreCategory" :value="store_category_index"
                        ...
                        <label style="padding:0 40upx;">{{store_category_rows[store_category_index].store_category_name}}</label>
                    </picker>
                </view>
            </view>
...
<script>
    ...
    import storeCategory from '@/components/shop/category.vue';
                        ...
                        success: function (data, status, msg, code) {
                            if (200 == status)
                            {
                                ...
                                if (data.company)
                                {
									...
									if(data.company.company_other_files){
										that.store_row.company_other_files = data.company.company_other_files.split(",")
									}else{
										that.store_row.company_other_files = []
									}
                                }
        ...
        methods: {
            ...
            submitinfo: function () {
				...
				for (let i = 0; i < that.attachmentList.length; i++) {
					that.imageUrl.push(that.attachmentList[i].url)
					params.company_other_files = that.imageUrl.join(",");
				 }
