    ...
    <view class="page">
        <view class="m-cells m-cells-form">
            <view class="m-cell" v-if="isSet">
                ...
                <view class="uni-icon uni-icon-eye m-cell-ft"  style="width: 100upx;text-align: left;"  :class="[!showPassword ? 'uni-active' : '']" @click="changePassword"></view>
...
export default {
    ...
    methods: {
        ...
        submitdata: function() {
			...
			if(this.old_pay_password == this.pay_password)
			{
				that.$.confirm(that.__('原密码不能与新密码相同！'));
				return;
			}
            var params = {
