<template>
	<view class="page">
		<view class="m-cells m-cells-form">
			...
			<view class="m-cell" style="padding: 2upx 30upx">
							...
							<view class="uni-uploader__files">
								<block v-if="user_avatar">
									<view class="uni-uploader__file">
										<image class="uni-uploader__img" :src="user_avatar" :data-src="user_avatar" @click.stop="upImgs"></image>
									</view>
								</block>
			...
			<view class="m-cell">
				...
				<view class="m-cell-bd">
					<input class="u-input" type="text" :value="user_realname" :placeholder="__('请输入真实姓名')" @input="inputReName" maxlength="30" />
				</view>
			</view>
			<view class="m-celli hide">
				<view class="m-cell-hd"><label class="u-label">{{__('身份证')}}</label></view>
				<view class="m-cell-bd">
					<input class="u-input" type="idcard" :value="user_idcard" :placeholder="__('请输入身份证号码')" @input="inputICard" maxlength="18" />
				</view>
			...
			<view class="m-cell">
				...
				<view class="m-cell-bd">
					<input class="u-input" type="text" :value="user_email" :placeholder="__('请输入邮箱地址')" @input="inputuser_email" maxlength="30" />
				</view>
		...
		<button class="u-btn u-btn-default" @click="submitInfo" style="margin-top:50upx;">{{__('保存')}}</button>
	...
	export default {
		...
		methods: {
			...
			update: function() {
				...
				if (!that.$.email(that.user_email)){
					that.$.confirm(that.__("请输入正确的邮箱！"));
					return;
				};
