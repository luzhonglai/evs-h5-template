                    ...
                    <view v-for="(item, index) in CaseDetailList"  :key="index" class="m-media-box m-media-box-appmsg">
                        <view class="m-media-box-bd">
                            ...
                            <view class="m-media-box-info">
                                <view class="m-media-box-info-meta m-tiem">{{__('时间：')}}{{item.record_time}}</view>
                            </view>
                        </view>
                    </view>
                </view>
...
<script>
	...
	export default {
		...
		data: function() {
			return {
                tapindex: 1, page: 1, ChangeType: 0, ispage: !0, flag: !0, CaseDetailList: []
			}
		},
...
<style lang="scss">
    ...
    .m-media-box-num{float: right;font-size: 32upx;}
    ...
    .m-scrollBox{padding-top:84upx;position: absolute;box-sizing: border-box;width: 100%;height: 100%; }
    .m-panel{margin-top:-4upx;}
    .m-num{float: right;color: $default-skin-bg}
    .m-panel-hd label{color: $default-skin-bg;font-size: 28upx;margin-left: 20upx;}
    .m-media-box{padding-top:20upx;padding-bottom: 20upx;line-height: 40upx;}
    .m-media-box-info{margin-top:5upx;}
    .m-media-box-title{font-size: 28upx;}
</style>
