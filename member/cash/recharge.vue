	...
	export default {
		...
		methods: {
            ...
            inputRecharge: function (e) {
                let that = this;
                this.setData({pdr_amount: e.detail.value}), that.$.isNull(e.detail.value) ? this.setData({isMoney: !1}) : /^\d+(?:\.\d{1,2})?$/.test(e.detail.value) && e.detail.value > 0  ? this.setData({isMoney: !0}) : this.setData({isMoney: !1})
            },
            ...
            gotopay: function () {
                ...
                that.setData({
                    ...
                    'paymentData': {
                        order_id: that.order_id,
                        orderSelMoneyAmount: that.pdr_amount,
                    }
                });
