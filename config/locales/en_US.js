let lang =  {
    ...
    "JDMall商城系统，支持原生App、微信小程序，邀请你一起体验！": "Welcome to Acha mall!",
    "正在加载": "Loading",
    ...
    "已领完": "Collected",
    "在线使用": "Online use",
    "支持线下使用（在门店购物时，向店员出示此码抵扣）": "Support offline use (show this code to the clerk for deduction when shopping in the store)",
    "使用条件": "Service conditions",
    "可用": "available",
    "查看": "See",
    "使用说明": "instructions",
    "支持线下使用，领取后向店员展示优惠券详情": "Support offline use, show the coupon details to the clerk after receiving",
    "优惠券详情": "Coupon details",
    "满￥%s可用，消耗 %s 积分领取。%s": "Full ￥% s available, consume% s points to collect. %s",
    "活动已结束": "Activity ended",
    "距离开始时间仅剩": "Only time to start",
    "活动时间仅剩": "Only time left",
    "原价": "Original price",
    "快试试刀法如何，看看你能砍掉多少": "Try the sabre technique and see how much you can cut",
    "您总共砍掉": "You cut it off altogether",
    "您的好友在参加砍价活动，快帮ta砍一刀，试试刀法~": "Your friend is participating in the bargaining activity. Please cut a knife for him and try the sabre technique~",
    "您帮好友砍掉": "You can cut it off for your friends",
    "已砍到底价啦！": "The price has been cut to the bottom!",
    "已砍": "Cut down",
    "开始砍价": "Start bargaining",
    "帮忙砍价": "Help bargain",
    "立即出手": "Move now",
    "找人帮砍": "Find someone to cut it",
    "我也要": "I want it, too",
    "再逛逛": "Go again",
    "您已购买，再逛逛": "You have already bought it, please visit again",
    "活动说明": "Activity description",
    "砍价高手": "Haggler",
    "砍掉价格": "Cut down the price",
    "成功砍价": "Successful bargaining",
    "太棒啦": "That's great",
    "立即砍价": "Bargain now",
    "砍": "cut",
    "底价": "Floor price",
    "亲，砍价商品正在备货中~": "Pro, bargain goods are in stock~",
    "我发起的": "I initiated",
    "我参与的": "I'm involved",
    "亲~您还没有砍价哦，": "Dear ~ you haven't bargain yet,",
    "拼": "Spell",
    "签到失败！": "Sign in failed!",
    "活动签到": "Event sign in",
    "立即报名": "Sign up now",
    "已报名": "Signed up",
    "报名已截止": "Enrollment is closed",
    "请输入姓名": "Please enter a name",
    "请输入电话": "Please enter the phone number",
    "请输入公司名称": "Please enter company name",
    "请输入职位": "Please enter position",
    "报名页": "Application page",
    "出错啦": "Error ",
    "报名成功！": "Registration succeeded!",
    "签到成功": "Sign in succeeded",
    "立即签到": "Sign in now",
    "未知": "Unknown",
    "暑期特供": "Summer special offer",
    "帮帮币": "Guild coins",
    "今日爆款": "Popular today",
    "活动商品列表": "List of active products",
    "零元购分享": "Zero yuan purchase and share",
    "零元购": "Zero yuan purchase",
    "帮帮币区间": "Guild currency range",
    "最低帮帮币": "Minimum guild coins",
    "最高帮帮币": "Highest guild coin",
    "高额返区": "High recurrent area",
    "天天秒淘": "Every second",
    "特价专区": "special offer ",
    "新人任选": "New selection",
    "超值专区": "Premium zone",
    "新人福利专享": "Exclusive benefits for new employees",
    "抢购中": "In rush",
    ...
    "精选": "Selected",
    "热门单品": "Hot items",
    "单品预告": "Product Preview",
    "零元购列表": "Zero purchase list",
    "您有系统消息未读": "You have unread system message",
    "发来消息， 是否接入聊天？": "Send a message. Do you want to chat?",
    "输入不参与优惠金额": "Enter the amount of non participation discount",
    "可使用": "Available",
    "确认支付": "Confirm payment",
    "附近没什么门店!": "There are no stores nearby!",
    "发生错误": "An error occurred",
    "距离本场开始还有": "It's still a long way to go",
    "距离本场结束还有": "It's still a long way to go",
    "确认": "confirm",
    "点击传e": "Click to send e",
    "请输入正确的数值": "Please enter the correct value",
    "选择表情包:": "Select expression Pack:",
    "激活索引:": "Activation index:",
    "添加表情包": "Add expression pack",
    "设置表情": "Set emoticons",
    "纵向滚动 scrollTop 值已被修改为 0": "Scroll vertically scrolltop value has been modified to 0",
    "组数:": "Number of groups:",
    "微笑": "Smile",
    "撇嘴": "Curl up",
    "色": "colour",
    ...
    "发怒": "Anger",
    "调皮": "naughty",
    "呲牙": "open the mouth and show the teeth",
    "惊讶": "surprised",
    "难过": "Sad",
    "酷": "Cool",
    "冷汗": "Cold sweat",
    ...
    "产地": "Place of Origin",
    "距离": "distance",
    "溯源": "Tracing to the source",
    "市场": "market",
    "确定要下载此附件吗": "Are you sure you want to download this attachment",
    "下载中,请稍后": "Downloading, please wait",
    "保存成功，路径为": "Saved successfully, path is",
    "下载失败": "Download failed",
    "下载中,进度": "Downloading, progress",
    "确定要删除此项吗？": "Are you sure you want to delete this item?",
    "已达到最大上传数量": "The maximum number of uploads has been reached",
    "选择图片": "Choose a picture",
    "选择文件": "Select file",
    "充值余额 (￥%s)": "Recharge balance (￥% s)",
    "现金券 (￥%s)": "Cash coupon (￥% s)",
    "数据未加载": "Data not loaded",
    "访问接口失败": "Provider failed",
    "触发了设置线条宽度:": "Triggered setting line width:",
    "初始化": "initialization",
    "执行了组件内的init函数": "Execute init function in component",
    ...
    "皖": "Wan",
    "闽": "Fujian",
    "赣": "short name for Jiangxi province",
    "鲁": "Lu",
    "豫": "Yu",
    "鄂": "Hubei",
    "湘": "Xiang",
    ...
    "领": "collar",
    "警": "police",
    "请输入完整的车牌号码": "Please input the complete license plate number",
    "请输入关键词搜索": "Please enter keyword search",
    "历史记录": "History",
    "猜你想搜的": "Guess what you want",
    ...
    "选择模式": "Select mode",
    "预算金额": "Budget amount",
    "建议您合理设置预算": "We suggest that you set up a reasonable budget",
    "需求标题": "Requirement title",
    "还差一个响亮的标题": "There's just a big title left",
    "需求描述": "Requirement description",
    "请描述您的需求...": "Please describe your needs",
    "上传附件": "Upload attachment",
    "地域要求": "Regional requirements",
    "人数上限": "Maximum number of people",
    "发布任务": "Publish task",
    "招标:多人竞标，择优选择": "Bidding: multiple bidders, select the best",
    "比稿:海量创意，任您挑选": "Draft comparison: a large number of creative ideas, you can choose",
    "上传成功": "Upload succeeded",
    "上传失败": "Upload failed",
    "投标成功！": "Bidding succeeded!",
    "投标失败！": "Bidding failed!",
    "是否确认提交验收？": "Are you sure to submit for acceptance?",
    "提交失败！": "Failed to submit!",
    "我正在使用HBuilderX开发uni-app，赶紧跟我一起来体验！": "I am using hbuilder x to develop uni app, so hurry to experience it with me!",
    "分享测试": "Share test",
    "微信好友": "Wechat friends",
    "朋友圈": "Wechat Moments",
    "微博": "micro-blog",
    "复制": "copy",
    "更多": "More",
    "点击按钮的序号: ": "Click the button's serial number:",
    "已复制到剪贴板": "Copied to clipboard",
    "任务报价:": "Task quotation:",
    "任务报价": "Task quotation",
    "工作周期:": "Working cycle:",
    "需要多少天": "How many days does it take",
    ...
    "任务大厅": "Mission Hall",
    "是否确认验收通过？": "Is the acceptance confirmed?",
    "验收成功！": "Acceptance succeeded!",
    "确认选择此方案中标？": "Are you sure to choose this scheme to win the bid?",
    "全部任务": "All tasks",
    "竞标中": "Bidding",
    "编号：": "No.:",
    "标题：": "title:",
    ...
    "验收中": "In acceptance",
    "未验收": "Not accepted",
    "确认验收": "Confirmation and acceptance",
    "亲~您还没有任务哦，": "Dear, you have no task,",
    "我发布的任务": "My published tasks",
    "我参加的任务": "Tasks I participated in",
    "手指上滑 取消发送": "Finger up to cancel sending",
    "页面捕获了socket数据": "Page captures socket data",
    "大黑哥": "Big black brother",
    "为什么温度会相差那么大？": "Why is the temperature so different?",
    "售后客服008": "After sales customer service 008",
    "这个是有偏差的，两个温度相差十几二十度是很正常的，如果相差五十度，那即是质量问题了。": "There is a deviation in this one. It is normal for two temperatures to differ by more than 20 degrees. If there is a difference of 50 degrees, it is a quality problem.",
    "欢迎进入聊天室": "Welcome to chat room",
    "售后客服008领取了你的红包": "After sales customer service 008 received your red bag",
    "恭喜发财，大吉大利，万事如意": "Congratulations on making a fortune, good luck and all the best",
    "恭喜发财": "May you be happy and prosperous",
    "触发删除操作": "Trigger delete operation",
    "恭喜发财，大吉大利": "Congratulations on making a fortune",
    "你领取了售后客服008的红包": "You get the red bag of after-sales customer service 008",
    "你领取了": "You got it",
    "自己": "Own",
    "的红包": "Red packets of",
    "按住 说话": "Hold to talk",
    ...
    "内容最长不能超过": "Content cannot be longer than",
    "个字符": "Characters",
    "加载中...": "Loading",
    "松开 结束": "Release end",
    "松开手指 取消发送": "Release finger to cancel sending",
    "取消发送录音": "Cancel sending recording",
    "输入群名称": "Enter group name",
    "群说明": "Group description",
    "召唤师": "Summoner",
    "确定要删除这段回忆吗？": "Are you sure you want to delete this memory?",
    "再看看": "I want to see others",
    "录像": "videotape",
    "图像": "image",
    "通知": "notice",
    "排行榜": "Ranking List",
    ...
    "版权": "copyright",
    "输入搜索的关键词": "Enter search keywords",
    "输入登录用户名": "Enter login user name",
    "输入登录密码": "Enter login password",
    "我也不知道干什么": "I don't know what to do",
    "你是不是忘了什么": "Did you forget something",
    "请输入手机号": "Please enter your mobile number",
    "请输入图片验证码": "Please enter the picture verification code",
    "请输入聊天昵称": "Please enter a chat nickname",
    "请输入6位以上包含数字、字母的密码": "Please enter a password with more than 6 digits including numbers and letters",
    "请确认你的密码": "Please confirm your password",
    "请先输入图片中的验证码": "Please enter the verification code in the picture first",
    "请将表格填写完整": "Please complete the form",
    "手机号格式不正确": "Incorrect format of mobile number",
    "两次密码不一致": "Two passwords are inconsistent",
    "输入聊天昵称": "Enter chat nickname",
    ...
    "我的地址": "My address",
    "广西壮族自治区南宁市西乡塘区大学西路29号": "29 Daxue West Road, XiXiangTang District, Nanning City, Guangxi Zhuang Autonomous Region",
    "警告": "warning",
    "你确定退出登录吗": "Are you sure you want to sign out",
    "输入验证信息": "Enter validation information",
    "可用余额": "Available balance",
    "转赠成功！": "Transfer succeeded!",
    "满￥%s可用，消耗%s积分领取。": "Full ￥% s available, consume% s points to collect.",
    "去赚众宝": "To earn treasure",
    "众宝明细": "Details of Zhongbao",
    "亲~您还没有众宝哦": "Dear, you don't have many treasures",
    "总余额(￥)": "Total balance (￥)",
    "余额(￥)": "Balance (￥)",
    "佣金(￥)": "Commission (￥)",
    "亲~可用佣金必须大于 %f 才可以申请！": "Pro ~ available commission must be greater than% F to apply!",
    "可转佣金(￥)": "Transferable Commission (￥)",
    "最小金额(%.2f)": "Minimum amount (%. 2f)",
    "提现规则": "Withdrawal rules",
    "粉丝在店铺内订单支付后你将会获得佣金收益，收益在买家确认收货后成交达成并结算到佣金账户。确认收货后": "You will get commission income after the fans pay the orders in the store. The income will be settled in the commission account after the buyer confirms the receipt. After confirming receipt",
    "天佣金可转入余额。订单若发生退款你将不会收到佣金收益。": "Daily commission can be transferred to the balance. You will not receive commission income if the order is refunded.",
    "申请提现": "Application for cash withdrawal",
    ...
    "银行名称": "Bank name",
    "银行卡号": "Bank card No",
    "输入__银行卡号": "Enter the bank card number",
    "提示:余额提现只支持全部金额提取，不支持部分金额提取。赠送的金额不支持提现，提现之后赠送的金额会被清零": "Tip: balance withdrawal only supports total amount withdrawal, not partial amount withdrawal. The amount of the gift does not support withdrawal. After withdrawal, the amount of the gift will be cleared",
    "佣金": "Commission",
    "本月预估收益(￥)": "Estimated income of this month (￥)",
    "亲~提现金额必须大于": "Cash withdrawal amount must be greater than",
    "才能提现哟！": "Only then can I withdraw cash!",
    "可提现佣金(￥)": "Withdrawable Commission (￥)",
    "输入提现金额(需要大于:": "Input withdrawal amount (greater than:",
    "不同意": "disagree",
    "十分抱歉，若您不同意此协议，我们将无法为您提现": "I'm sorry, if you don't agree with this agreement, we can't withdraw cash for you",
    "返回": "Return",
    "我再想想": "I'll think about it again",
    "时间：": "Time:",
    "充值金额": "Recharge amount",
    "赠送:": "give:",
    "充值说明": "Recharge description",
    "充值": "Recharge",
    "成功邀请一位好友，可获积分奖励：": "If you invite a friend successfully, you will be rewarded with points:",
    "枚": "Mei",
    "数据格式错误": "data in wrong format",
    "暂无您的浏览记录": "No browsing records for you",
    "可以去看看哪些想要买的": "You can see what you want to buy",
    "随便逛逛": "Look around",
    "我的足迹": "My Tracks ",
    "会员卡": "membership card",
    ...
    "地区": "region",
    "确认要取消这个店铺吗？": "Are you sure you want to cancel this store?",
    "确认后可获得成长值,获取成长值=订单金额*": "Growth value can be obtained after confirmation, and the growth value = order amount*",
    "提交一个订单并且通过审核后最高可获得": "Submit an order and get the highest after passing the review",
    "个成长值。": "Growth value.",
    "每日签到可获得": "Daily check-in is available",
    "个成长值": "Growth value",
    "购买商品订单交易完成后可获得": "Available after purchase order transaction",
    "未读": "Unread",
    "消息": "news",
    "发送于": "Sent to",
    ...
    "金额": "Amount of money",
    "扫码支付": "Scanning payment",
    "余额 ￥%s": "Balance ￥% s",
    "佣金 ￥%s": "Commission ￥% s",
    "签订协议成功！": "Signed the agreement successfully!",
    "只有店主才可激活店铺": "Only the owner can activate the shop",
    "申请成功,待审核": "Application succeeded, to be approved",
    "入驻类型": "Type of residence",
    "店铺名称": "Shop name",
    ...
    "联系手机": "Contact mobile",
    "请输入联系手机": "Please input the contact phone",
    "企业地址": "Business address",
    "请输入企业地址": "Please enter the business address",
    "营业执照": "Business license",
    "其它证件": "Other documents",
    "线上网店商家": "Online shop merchants",
    "线下门店商家": "Offline store merchants",
    "请选择经营类目": "Please select business category",
    "商家入驻": "Merchants settled in",
    "请上传营业执照": "Please upload the business license",
    "请填写完整资料！": "Please fill in the complete information!",
    "编号：%s": "No.:% s",
    "待发货": "To be delivered",
    "物流状态：": "Logistics status:",
    "退货数量必填！": "Return quantity is required!",
    "优惠:￥": "Offer:￥",
    "搜索商品": "Search for items",
    "请尽快去商城后后台完善内容哦": "Please go to the back office of the mall to improve the content as soon as possible",
    "请选择你的个人联系信息！": "Please select your personal contact information!",
    "你还没有个人联系信息,马上": "You don't have personal contact information. Now",
    "获得红包": "Get red envelopes",
    "你有 ￥%s": "You have ￥% s",
    "发布需求": "Release requirements",
    "我的需求": "My needs",
    "我的任务": "My mission",
    "存储privacyFlag": "Storage privacyflag",
    "十分抱歉，若您不同意《隐私政策》，我们将无法为您提供服务器": "We are sorry, if you do not agree to the privacy policy, we will not be able to provide you with a server",
    "关闭应用": "Close app",
    ...
    "返利￥%.2f": "Rebate ￥%. 2F",
    "佣金￥%.2f": "Commission ￥%. 2F",
    "配置有误！": "Configuration error!",
    "请输入房间名称！": "Please enter the room name!",
    "请输入房间名称（必填）": "Please enter room name (required)",
    ...
    "审核失败": "Audit failed",
    "无法备齐货物": "Unable to prepare goods",
    "最多上传5张图片！": "Upload up to 5 pictures!",
    "输入订单号进行搜索": "Enter order number to search",
    "待审核": "To be reviewed",
    "含运费": "Including freight",
    "出库": "Out of stock",
    "待订单审核": "Pending order approval",
    "待财务审核": "Pending Financial Review",
    "暂无数据": "No data available",
    "订单管理": "Order management",
    "请输入提货码\/服务码进行核销": "Please enter delivery code \/ service code for verification",
    "条码类型：": "Barcode type:",
    "条码内容：": "Barcode content:",
    "请输入查询数据": "Please enter query data",
    "请选择商品分类": "Please select commodity classification",
    "请填写商品名称": "Please fill in the product name",
    "请填写商品市场价": "Please fill in the market price",
    "请填写商品销售价": "Please fill in the selling price",
    "请填写商品数量": "Please fill in the quantity of goods",
    "请填写商品属性编号": "Please fill in the product property number",
    "请填写商品描述": "Please fill in the product description",
    "商品添加成功": "Item added successfully",
    "是否下架商品?下架还可以在仓库中上架": "Are you sure you want to take off the shelves? You can also take off the shelves in the warehouse",
    "是否删除商品?删除后系统将不再保存": "Do you want to delete the product? The system will not save it after deletion",
    "是否上架商品?上架后可以正常销售": "Are the goods on the shelves? They can be sold normally after they are on the shelves",
    "请输入商品标题进行搜索": "Please enter product title to search",
    "商品管理": "Commodity management",
    "分销成功！": "Distribution succeeded!",
    "已经分销": "Distributed",
    "请选择客户": "Please select a customer",
    "请选择商品": "Please select a product",
    "输入商品名进行搜索": "Enter product name to search",
    "生成订单": "Generate order",
    "输入手机号或车牌号进行搜索": "Enter mobile number or license plate number to search",
    "选择客户": "Select customer",
    "商品名称： %s": "Product Name:% s",
    "修改成功！": "Modification succeeded!",
    "修改失败": "Modification failed",
    "请输入店铺电话": "Please enter the shop phone number",
    "请输入店铺所在地区": "Please enter the location of the store",
    ...
    "确定保存?": "Are you sure to save?",
    "请输入发件人姓名": "Please enter the sender's name",
    "发件人": "From",
    "发货地址管理": "Shipping address management",
    "请点此输入": "Please click here to enter",
    "请选择车型分类": "Please select model classification",
    "添加成功": "Successfully added",
    "车牌号": "license plate number",
    "常用轮胎品牌": "Common tire brands",
    "请选择常用轮胎品牌": "Please select a common tire brand",
    "车型分类": "Model classification",
    "请选择店员": "Please select a clerk",
    "店员": "Clerk",
    "收货地址管理": "Receiving address management"
}
