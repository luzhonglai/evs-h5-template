...
if (!debug){
	bu = "https://dev-jdmall.vwdsso.com";
	mu = bu + "/api";
}
...
export default {
	...
	URL: {
		...
		"download_proxy": "https://dev-jdmall.vwdsso.com/shop/api/download.php",
		"account": {
		...
		"live": {
			//"checkPerm": "https://dev-jdmall.vwdsso.com/index.php?mdu=live&ctl=Live&met=checkPerm&typ=json",
			"checkPerm": ip + "sns/Live/checkPerm",
			//"saveRoom": "https://dev-jdmall.vwdsso.com/index.php?mdu=live&ctl=Live&met=saveRoom&typ=json",
